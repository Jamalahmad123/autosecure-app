          ...
          <div className="py-14 grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-10">
                <Link className="btn py-8 h-0 px-4 text-lg font-mdeium capitalize text-white bg-clrPrimary hover:bg-clrSky border-none gap-2 w-full rounded-none flex-nowrap">
