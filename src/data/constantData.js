...
export const acheivements = [
  ...
  },
  {
    ...
    details: {
      ...
      desc: "Besondere Auszeichnung für autosecure aus Münster. Das börsennotierte Technologie-Unternehmen HikVision mit über 42.000 Mitarbeitern und führenden IoT-Lösungen im Bereich der Video-Remote Security verleiht dem Sicherheits- und Automations-Spezialisten autosecure den Outstanding Performance Award für herausragende Leistungen.",
      html: `
        <p>Hard- und Software in perfekter Symbiose. Die Produkte von HikVision gelten im Bereich der Video-Technologien als Gold-Standard und vereinen Hard- und Software mit einzigartigen Features im Bereich der <a href="/solutions/security-solutions/active-video-surveillance">Video-Remote-Security</a>. Angefangen bei einfachster Installation, SeeClear-Technology bei absoluter Dunkelheit, Deep-Learning Algorithmen und Einsatz von künstlicher Intelligenz, High-End 4K Auflösung für gestochen scharfe und flüssige Bilder, Seamless-Image-Stitching-Technologie für die Abdeckung von großen Bereichen mit nur einer Kamera bis hin zu Wärmebildtechnik für die Sichtbarkeit von thermaler Strahlung – all diese Eigenschaften bilden die Basis für die vollautomatisierten Video-Remote-Security Lösungen von autosecure.</p>

        <p>„Mit der Hard- und Software-Technologie von unserem Partner-Unternehmen HikVision und dem ganzheitlichen <a href="/solutions/security-solutions/active-video-surveillance">Sicherheitskonzept</a> von autosecure sind wir in der Lage, Kosten für personalbasierte Überwachungslösungen um mindestens 50% zu reduzieren und gleichzeitig 100% weniger Schadensfälle zu gewährleisten“. erklärt autosecure Geschäftsführer Stefan Chüo.</p>

        <p>autosecure ist spezialisiert auf technologiebasierte Automations-Lösungen für die Automobil- und Mobilitätsindustrie und bietet im Bereich der ​<a href="/solutions/security-solutions/active-video-surveillance">Security-Lösungen</a> , aktive Videoüberwachung mit Live-Täteransprache nach dem eigens entwickelten SAVE-Prinzip. Das hauseigene Alarmcenter zur Echtzeit-Überwachung und Live-Täteransprache gewährleistet 24/7 automatisierte Sicherheit und lässt sich standortindividuell und nahtlos in die individuellen Geschäftsabläufe auf Kundenseite integrieren. Mit smarten Finanzierungs- und Leasingmodellen werden hohe Investitionskosten vermieden und schonen die Liquidität der Unternehmen.</p>

        <p>„Für viele unserer Kunden aus der Automobil-Branche – allen voran Autohäuser und Autoparks – mit einem umfangreichen Produkt-Portfolio und großen Arealen, spielt das Thema Sicherheit eine zentrale Rolle. Mit unserem Partner HikVision können wir nicht nur Investitionssicherheit aufgrund modernster und zukunftsweisender Technologien garantieren, sondern helfen unseren Kunden mittelfristig auch bei der Reduktion von Versicherungsbeiträgen durch ausbleibende Diebstahl- und Schadensereignisse und erheblichen Einsparungen von Zeit- und Rechercheaufwand für zu klärende Ereignisse auf dem Betriebsgelände.“ erläutert autosecure Geschäftsführer Stefan Chüo.</p>

        <p>Die hohe Nachfrage für die technologiebasierten und vollautomatisierten ​<a href="/solutions/security-solutions/active-video-surveillance">Sicherheits-Lösungen</a> von autosecure belegen den Mehrwert auf Kundenseite. Innerhalb eines Jahres nach Gründung zählen namhafte Unternehmen aus der Automobil- und Mobilitätsbranche zum Kunden-Portfolio und setzen auf die zukunftsweisenden Sicherheitslösungen von autosecure. Honoriert wurden diese Leistungen nun mit dem Outstanding Performance Award von HikVision – einem der weltweit führenden Hersteller im Bereich der Video-Remote-Security.</p>
        <p>Weitere Informationen zu HikVision unter ​<a href="https://www.hikvision.com/de/">www.hikvision.com/de/</a>.</p>
      `,
    },
  },
];
